            ...
            <div className="col-xl-3 col-lg-3 col-md-6 mb-3">
              <div className="card h-100" key={e.c_id}>
                ...
                <div className="card-body">
                  <h5 className="card-title text-center"><i className="fad fa-file-certificate"></i> {e.c_name}</h5>
            ...
            <div className="card card-blog card-background cursor-pointer">
              ...
              <div className="card-body">
                <div className="content-left text-start my-auto py-4">
                  ...
                  <a href="all_certificate" className="text-white text-sm icon-move-right f1">ดูเพิ่มเติม
