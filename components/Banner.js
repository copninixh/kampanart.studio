...
export default function Banner() {
    ...
    return(
            <div>
                <div className="py-sm-7 py-5 position-relative page-header bg-banner min-vh-100">
                                    ...
                                    <div className="row py-lg-4 py-5">
                                        ...
                                        <div className="col-lg-9 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mt-sm-0 mt-4">
                                            <div className="d-flex justify-content-between align-items-center mb-2">
                                                <h4 className="mb-0 text-bold text-white">Copninich | <span ref={textRef}></span></h4>
                                                <div className="d-block">
                                                    <a href="https://github.com/copninich" className="btn btn-sm btn-outline-light  btn-round text-nowrap mb-0">Follow</a>
                                                </div>
                                            </div>
